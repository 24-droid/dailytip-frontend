    ...
    <div>
      <div className='relative min-h-screen z-50 bg-white' style={{ paddingTop: '5%' }}>
        ...
        <div className=' relative flex flex-col items-center justify-center'>
          <h1 className='font-bold text-center text-black' style={{ fontWeight: 'bold', fontSize: '1.2rem' }}>Hi, I'm Om.</h1>
          <h1 className='text-center text-black' style={{ fontSize: '2.1rem', lineHeight: '1.2', fontFamily: 'Roboto', fontWeight: 'bold', marginTop: '1rem' }}>Subscribe to get the tips to build the web better.</h1>
          <div>
            <div className='flex flex-col  gap-1' style={{ fontSize: '1.1rem', marginTop: '0.8rem' }}>
              ...
              <p className='text-center text-balance text-black'>So here we go we daily provide tips to stay updated with the modern web development, Become more resilient.</p>
            </div>
            <div>
          ...
          <div className='border-b-2 border-gray-500' style={{ borderBottom: '2rem', borderColor: 'gray' }}>
            <em style={{ fontStyle: 'italic', paddingLeft: '2rem', marginTop: '1rem' }} className='flex flex-wrap md:text-balance md:w-180 text-black'>The world is full of innovations, but the world of web development is still in its infancy. We are here to help you stay updated with the latest trends and developments in the field.</em>
